...
func _is_moving() -> bool:
	return _player_context_module.physics.movement_directions.x != 0 or _player_context_module.physics.movement_directions.z != 0

func _is_moving_forward() -> bool:
	return _player_context_module.physics.movement_directions.z < 0
