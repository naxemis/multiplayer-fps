...
func _is_moving() -> bool:
	return _context.movement_directions.x != 0 or _context.movement_directions.z != 0

func _is_moving_forward() -> bool:
	return _context.movement_directions.z < 0

func _has_stamina_for(cost: float) -> bool:
	return _context.stamina - cost > 0 and _context.stamina > _context.stamina_safe_zone
...
func _can_enter_jump() -> bool:
	...
	return input_jump and _can_jump_off_ground() and no_blocked_state and _has_stamina_for(_context.jump_stamina_drain)
